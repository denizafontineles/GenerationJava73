...
public class CollectionSet {
	...
	public static void main(String[] args) {
		...
		/**
		 * Mostra os dados armazenados na Collection Set Observe que 
		 * as frutas repetidas foram inseridos apenas uma vez
		 */
		
		System.out.println("\nDados da Collection: " + setFrutas);
		
		for(String i : setFrutas) {
			if(i != null) System.out.println("\nA posição de " + i + " é: " + i.hashCode());
		}
